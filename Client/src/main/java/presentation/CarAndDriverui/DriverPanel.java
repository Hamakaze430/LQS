...
public class DriverPanel extends JPanel {
	...
	private void init() {
		...
		JLabel searchLabel = new JLabel("· 请输入要查询的司机编号：");
	...
	protected void searchDriver(String s) {
		// TODO Auto-generated method stub
		searchid.setText("");
		int index = -1;
		...
		if (index == -1){
			JOptionPane.showMessageDialog(null, "找不到对应的司机信息！","", JOptionPane.ERROR_MESSAGE);
			initTable();
			return;
		}
